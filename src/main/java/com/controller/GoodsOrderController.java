...
//                            goodsOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R receiving(Integer id){
        ...
        QishouJiedanEntity qishouJiedanEntity1 = qishouJiedanService.selectOne(new EntityWrapper<QishouJiedanEntity>().eq("goods_order_id",id));
        qishouJiedanEntity1.setQishouJiedanTypes(2);
        boolean b1 = qishouJiedanService.updateById(qishouJiedanEntity1);
        if(!b1){
            return R.error("出错");
        }
        return R.ok();
