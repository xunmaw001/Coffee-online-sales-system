...
public class GoodsEntity<T> implements Serializable {
     ...
     * 进货商
     */
    @TableField(value = "goods_jinhuoshang")

    private String goodsJinhuoshang;
	 ...
	 * 设置：进货商
	 */
    public String getGoodsJinhuoshang() {
        return goodsJinhuoshang;
    }
    ...
    public void setGoodsJinhuoshang(String goodsJinhuoshang) {
        this.goodsJinhuoshang = goodsJinhuoshang;
    }
    /**
	 * 设置：商品库存
	 */
    ...
    public String toString() {
        return "Goods{" +
            ...
            ", goodsJinhuoshang=" + goodsJinhuoshang +
