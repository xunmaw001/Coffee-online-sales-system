            ...
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    ...
                    <div class="blog-details-header">
                        ...
                        <ul class="post-meta">
                            <li v-if="detail.goodsTypes">商品类型：
                                {{detail.goodsValue}}
                            </li>
                            <li v-if="detail.goodsJinhuoshang">进货商：
                                {{detail.goodsJinhuoshang}}
                            </li>
                            <li v-if="detail.goodsKucunNumber">商品库存：
                                {{detail.goodsKucunNumber}}
                            </li>
                            <li v-if="detail.goodsOldMoney">商品原价：
...
<script>
    ...
    function addGoodsOrder(){
        ...
        localStorage.setItem('goodss', JSON.stringify([{
            ...
            goodsJinhuoshang: vue.detail.goodsJinhuoshang,
