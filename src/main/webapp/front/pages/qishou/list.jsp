                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="qishouName" id="qishouName" placeholder="骑手姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#qishouName').val() != null && jquery('#qishouName').val() != "" && jquery('#qishouName').val() != "null" ) {
                param['qishouName'] = jquery('#qishouName').val();
            }
            ...
            // 获取列表数据
            http.request('qishou/list', 'get', param, function(res) {
