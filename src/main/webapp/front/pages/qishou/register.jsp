            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">骑手姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qishouName" id="qishouName"  placeholder="骑手姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">骑手手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qishouPhone" id="qishouPhone"  lay-verify="phone|required"   placeholder="骑手手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">骑手身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qishouIdNumber" id="qishouIdNumber"  lay-verify="identity|required"   placeholder="骑手身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
