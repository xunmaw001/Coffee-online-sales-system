    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="newtit">
                        <h2>新闻信息展示</h2>
                        <span class="index_intro">NEWS</span>
                    </div>
                    <br />
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in newsList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.newsName}}</h4>
                                <p v-if="item.newsNewMoney != null" style="color: red;" >￥{{item.newsNewMoney}}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in goodsList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../goods/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.goodsPhoto?item.goodsPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.goodsName}}</h4>
                                <p v-if="item.goodsNewMoney != null" style="color: red;" >￥{{item.goodsNewMoney}}</p>
                            </div>
                        </div>
                    </div>
                </div>
