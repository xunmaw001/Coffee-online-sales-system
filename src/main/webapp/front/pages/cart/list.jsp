        ...
        <table class="layui-table" lay-skin="nob">
            ...
            <tr v-for="(item,index) in dataList" v-bind:key="index">
                <td style="display: flex;text-align: left;">
                    <img :src="item.goodsPhoto" style="width: 50px;height: 50px;object-fit: cover;">
                    <div style="margin-left: 10px;margin-top: 10px;">
                        {{item.goodsName}}
                    </div>
                </td>
                <td style="width: 200px;">{{item.goodsNewMoney}} RMB</td>
                ...
                <td style="width: 200px;">{{item.goodsNewMoney*item.buyNumber}} RMB</td>
