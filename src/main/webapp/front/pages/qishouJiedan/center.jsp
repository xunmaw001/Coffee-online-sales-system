    ...
    <ul class="layui-nav layui-nav-tree">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							<label class="layui-form-label">送单状态</label>
							<div  class="layui-input-inline" style="width: 500px">
								<select name="qishouJiedanTypes" id="qishouJiedanTypes">
                                    <option v-for="item in qishouJiedanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`qishouJiedan/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function qishouJiedanTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qishou_jiedan_types", "GET", {}, (res) => {
					   if(res.code == 0){
						   vue.qishouJiedanTypesList = res.data.list;
					   }
				   });
			   }
