...
<script>
    ...
    // 当前表的字典表
        ...
        function qishouJiedanTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qishou_jiedan_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('qishouJiedan/list', 'get', param, function(res) {
