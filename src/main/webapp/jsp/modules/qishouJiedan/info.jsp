            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">骑手接单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>收获地址</label>
                                            <input style="width: 450px" id="addressId" name="addressId" class="form-control"
                                                   v-model="ruleForm.addressId" readonly>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label>商品</label>
                                            <input style="width: 450px" id="goodsId" name="goodsId" class="form-control"
                                                   v-model="ruleForm.goodsId" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="qishouName" name="qishouName" class="form-control"
                                                   v-model="ruleForm.qishouName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>头像</label>
                                        <img id="qishouPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>骑手手机号</label>
                                            <input style="width: 450px" id="qishouPhone" name="qishouPhone" class="form-control"
                                                   v-model="ruleForm.qishouPhone" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="qishouIdNumber" name="qishouIdNumber" class="form-control"
                                                   v-model="ruleForm.qishouIdNumber" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="qishouId" name="qishouId" v-model="ruleForm.qishouId" readonly type="hidden">
                                <input id="goodsOrderId" name="goodsOrderId" v-model="ruleForm.goodsOrderId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>送单状态</label>
                                    <input style="width: 450px" id="qishouJiedanValue" name="qishouJiedanValue" class="form-control"
                                           v-model="ruleForm.qishouJiedanValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "qishouJiedan/info/" + id,
