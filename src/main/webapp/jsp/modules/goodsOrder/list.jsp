...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(goodsPhotoCell);
                    ...
                    //进货商
            var goodsJinhuoshangCell = document.createElement('td');
            goodsJinhuoshangCell.innerHTML = item.goodsJinhuoshang;
            row.appendChild(goodsJinhuoshangCell);
            ...
            if(item.goodsOrderTypes == 2 && window.sessionStorage.getItem('role') == "骑手"){
                //接单
                var detailListBtn = document.createElement('button');
                var detailListAttr = "jiedan(" + item.id+')';
    ...
    //查询当前表搜索条件所有列表
        ...
        function jiedan(id) {
            ...
            httpJson("goodsOrder/update", "post",data, (res) => {
                if(res.code == 0){
                    alert('接单成功');
                    var params = {
                        goodsOrderId:id,
                    ...
                    httpJson("qishouJiedan/save", "post",params, (res) => {
                        if(res.code == 0){
                        }
                    });
