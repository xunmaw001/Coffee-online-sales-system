                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>骑手姓名</label>
                                    <input id="qishouName" name="qishouName" class="form-control"
                                           placeholder="骑手姓名">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>骑手手机号</label>
                                    <input id="qishouPhone" name="qishouPhone" class="form-control"
                                           onchange="qishouPhoneChickValue(this)"  placeholder="骑手手机号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>骑手身份证号</label>
                                    <input id="qishouIdNumber" name="qishouIdNumber" class="form-control"
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("qishou/register", "POST", data, (res) => {
                    if(res.code == 0){
