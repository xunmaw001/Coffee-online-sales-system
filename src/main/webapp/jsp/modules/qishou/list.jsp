...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">骑手管理</li>
                            <li class="breadcrumb-item active">骑手列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="qishouNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="骑手姓名" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
            ...
            //骑手姓名
            var qishouNameSearchInput = $('#qishouNameSearch');
            if( qishouNameSearchInput != null){
                if (qishouNameSearchInput.val() != null && qishouNameSearchInput.val() != '') {
                    searchForm.qishouName = $('#qishouNameSearch').val();
                }
            }
        ...
        function getDataList() {
            http("qishou/page", "GET", {
                ...
                qishouDelete: 1,
                //本表的
                qishouName: searchForm.qishouName,
        ...
        function setDataRow(item, number) {
            ...
            //骑手姓名
            var qishouNameCell = document.createElement('td');
            qishouNameCell.innerHTML = item.qishouName;
            row.appendChild(qishouNameCell);

                //头像
            var qishouPhotoCell = document.createElement('td');
            var qishouPhotoImg = document.createElement('img');
            var qishouPhotoImgValue = item.qishouPhoto;
            if(qishouPhotoImgValue !=null && qishouPhotoImgValue !='' && qishouPhotoImgValue !='null'){
                qishouPhotoImg.setAttribute('src', qishouPhotoImgValue);
                qishouPhotoImg.setAttribute('height', 100);
                qishouPhotoImg.setAttribute('width', 100);
                qishouPhotoCell.appendChild(qishouPhotoImg);
            }else{
                qishouPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(qishouPhotoCell);

            //骑手手机号
            var qishouPhoneCell = document.createElement('td');
            qishouPhoneCell.innerHTML = item.qishouPhone;
            row.appendChild(qishouPhoneCell);


            //骑手身份证号
            var qishouIdNumberCell = document.createElement('td');
            qishouIdNumberCell.innerHTML = item.qishouIdNumber;
            row.appendChild(qishouIdNumberCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addqishou", "addqishou");
            window.location.href = "add-or-update.jsp"
        }
