                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 goodsJinhuoshangDiv">
                                        <label>进货商</label>
                                        <input style="width: 450px" id="goodsJinhuoshang" name="goodsJinhuoshang" class="form-control"
                                               placeholder="进货商">
                                    </div>
...
<script>
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#goodsJinhuoshang").val(ruleForm.goodsJinhuoshang);
